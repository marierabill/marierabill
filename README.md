...
## 🚀 About Me  
💻 I’m an **Application Analyst & Computer Science graduate** passionate about building reliable, user-friendly, and secure IT systems.  
🌍 Skilled in **application support, troubleshooting, databases, networking, and cloud technologies (Azure, AWS)**.  
🏥 Currently focusing on **healthcare & enterprise IT systems** where technology directly improves service delivery.  
📚 Lifelong learner — always upskilling in **ITIL, Networking, and Security+**.  

---

## 🏅 Credentials & Certifications  
- 🎓 **B.Sc. Computer Science – Egerton University**  
- 📜 *Certifications:*  
  - Learn CCNA 200-301 Network Fundamentals – Simplilearn LMS  
  - Introduction to ITIL® V4 – Simplilearn LMS  
  ...
  - Introduction to Forest and Landscape Restoration – FAO eLearning  
  - An Introduction to Urban and Peri-urban Forestry – FAO eLearning  

---

## ⚡ What I'm Working On  
- 🔭 Supporting and enhancing **enterprise and healthcare applications**  
- 🌐 Exploring **system integrations, APIs, and cloud deployments**  
- 📖 Studying towards **CompTIA Security+, Microsoft Azure Developer, AWS Developer Associate**  
- 👯 Open to collaboration in **application support, networking, and cloud solutions**  
...
![Networking](https://img.shields.io/badge/Networking-00629B?style=flat&logo=cisco&logoColor=white)  
